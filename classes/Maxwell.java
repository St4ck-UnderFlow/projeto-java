...
public class Maxwell {
    ...
    public Maxwell() {
        ...
        this.currentThreshold = 500; // The current threshold of Maxwell, it may change during his journey 
        this.travelCoins = 300; // Amount of coins Maxwell currently holds (he starts with 3 coins)
